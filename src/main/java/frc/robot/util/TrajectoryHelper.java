...
public class TrajectoryHelper {
     ...
     * 
     * @param delta_height height from the projectile's initial position to the target
     * @param distance horizontal distance from the target
     * @param entry_angle desired angle for the projectile to enter the target at
     * @return double[] {target_angle, target_velocity} where target_angle and target_velocity are the angle and velocity, respectively, that a projectile must start at to reach the target.
     *
     */
