...
public class REVDigitMXPDisplay {
	 ...
	 * 
	 * @param text The text to be written. Text will be processed similarly to {@link #displayText(String)}
	 * Note that because text is processed with the same rules as {@link #displayText(String)}, nothing will be shown on the display when the scrolling section contains only periods.
